...
export const Anchors: React.FC = () => {
  return (
    <>
      ...
      <Box>
        <Button as="a" href="https://bunnymoon.info" mr="8px" external disabled>
          Disabled
        </Button>
        <Button as="a" href="https://bunnymoon.info" variant="secondary" external disabled>
          Disabled
        </Button>
      </Box>
    </>
